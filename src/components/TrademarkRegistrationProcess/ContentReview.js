...
const ContentReview = ({
    ...
    setNgayKQTraLoihamDinhND_DuKien,
    ngayKQTraLoiThamDinhND,
    setNgayKQTraLoiThamDinhND
}) => {
    return (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    ...
                    <input
                        type="date"
                        disabled
                        value={ngayKQTraLoiThamDinhND_DuKien}
                        onChange={(e) => setNgayKQTraLoihamDinhND_DuKien(e.target.value)}
                ...
                <div>
                    ...
                    <input
                        type="date"
                        value={ngayKQTraLoiThamDinhND}
                        onChange={(e) => setNgayKQTraLoiThamDinhND(e.target.value)}
