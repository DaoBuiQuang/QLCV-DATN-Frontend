...
const DocumentSection_KH = ({ initialTaiLieus, onTaiLieuChange, isAddOnly, isViewOnly, maHoSoVuViec, giayUyQuyenGoc, setGiayUyQuyenGoc, maUyQuyen, setMaUyQuyen }) => {
...
export default DocumentSection_KH;
