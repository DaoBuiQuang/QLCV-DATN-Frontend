...
function VuViec_Bil_KHBiTuChoiList() {
    ...
    const fetchCases = async (searchValue, partnerId, countryId, customerId, casetypeId, staffId, page = 1, size = 10) => {
        ...
        try {
            ...
            const response = await callAPI({
                method: "post",
                endpoint: "/billing_kh_bituchoi/list",
                data: {
    ...
    return (
        <div className="p-1 bg-gray-100 ">
            <div className="bg-white p-4 rounded-lg shadow-md">
                <h2 className="text-2xl font-semibold text-gray-700 mb-4 uppercase">📌 Danh sách nghiệp vụ bị từ chối xuất yêu cầu thanh toán campuchia</h2>
...
export default VuViec_Bil_KHBiTuChoiList;
