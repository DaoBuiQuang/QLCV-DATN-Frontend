    ...
    return (
        <div className="p-1 bg-gray-100 ">
            <div className="bg-white p-4 rounded-lg shadow-md">
                <h2 className="text-2xl font-semibold text-gray-700 mb-4 uppercase">📌 Danh sách nghiệp vụ đã xuất yêu cầu thanh toán được duyệt</h2>
...
export default VuViec_BillList;
