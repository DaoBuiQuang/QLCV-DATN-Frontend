    ...
    const fetchGeneralAdvices = async (searchValue, page = 1, size = 10) => {
        try {
            ...
            const response = await callAPI({
                method: "post",
                endpoint: "/generaladvices_vn/list",
                data: {
                    keyword: searchValue,
                    pageIndex: page,
                    pageSize: size,
    ...
    return (
        <div className="p-1 bg-gray-100 min-h-screen">
            <div className="bg-white p-4 rounded-lg shadow-md">
                <h2 className="text-2xl font-semibold text-gray-700 mb-4">📌 Danh sách tư vấn chung (VN)</h2>
                <div className="flex flex-col md:flex-row md:justify-between md:items-center gap-4 mb-4">
                    ...
                    <div className="flex gap-3">
                        ...
                        <button
                            onClick={() => navigate("/generaladviceadd_vn")}
                            className="bg-[#009999] hover:bg-[#007a7a] text-white px-5 py-3 rounded-lg shadow-md transition"
                        >
                            Thêm mới
                        </button>
...
export default GeneralAdviceList_VN;
