...
function GroupAdd() {
  ...
  const handleAddGroup = async () => {
    try {
      ...
      await showSuccess("Thành công!", "Thêm nhóm thành công!");
      setMaNhom("");
      setTenNhom("");
      setMoTa("");
      setGhiChu("");
      ...
      showError("Thất bại!", "Đã xảy ra lỗi khi thêm nhóm.");
    }
  };
  ...
  return (
    <div className="p-1 bg-gray-100 flex items-center justify-center">
      <div className="bg-white p-4 rounded-lg shadow-md w-full max-w-3xl">
        <h2 className="text-2xl font-semibold text-gray-700 mb-4">📂 Thêm nhóm mới</h2>
